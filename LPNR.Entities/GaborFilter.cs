...
namespace LPNR.Entities
{
    public static class GaborFilter
    {
        ...
        public static System.Drawing.Image GaborAndSomeFilter(System.Drawing.Image img)
        {
        ...
        private static int[] sinir(List<IntPoint> list)
        {
